...
//     const profilePic = user ? user.avatar : "https://via.placeholder.com/50x50/4F46E5/ffffff?text=JD";
...
//                         <p className="text-gray-400 text-xs">@{username.toLowerCase().replace(' ', '')}</p>
//                     </div>
//                 </div>
//             </div>
        ...
        <div className="fixed left-0 top-0 h-full w-64 bg-[#0F1419] border-r border-gray-800 z-40">
            ...
            <div className="p-4 border-t border-gray-800">
                <button
                    ...
                    className="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-300 hover:bg-red-500/10 hover:text-red-400 transition-all duration-200 w-full"
                >
                    <i className="fas fa-sign-out-alt w-5 text-center"></i>
                    <span className="font-medium">Logout</span>
                </button>
